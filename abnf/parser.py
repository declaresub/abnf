...
class Rule(object):
    ...
    def __new__(cls, name, definition=None):  # pylint: disable=unused-argument
        ...
        _name = name.casefold()
        return cls._obj_map.get((cls, _name),
                                cls._obj_map.get((Rule, _name),
                                                 super(Rule,
                                                       cls).__new__(cls)))
    ...
    @classmethod
    def make_parser_alternation(cls, node):
    ...
    @classmethod
    def make_parser_char_val(cls, node):
        """Creates a CharVal object from char-val node."""
        return CharVal(node)

    @classmethod
    def make_parser_concatenation(cls, node):
    ...
    @classmethod
    def make_parser_group(cls, node):
    ...
    @classmethod
    def make_parser_num_val(cls, node):
        """Creates a NumVal object from num-val node."""

        return NumVal(node)

    @classmethod
    def make_parser_option(cls, node):
